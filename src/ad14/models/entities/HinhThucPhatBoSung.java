...
public class HinhThucPhatBoSung {

    private long idHinhThucPhatBoSung;
    private String noiDungPhatBoSung;
    ...
    public String getNoiDungPhatBoSung() {
        return noiDungPhatBoSung;
    }

    public void setNoiDungPhatBoSung(String noiDungPhatBoSung) {
        this.noiDungPhatBoSung = noiDungPhatBoSung;
    }
