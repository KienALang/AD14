...
<head>
    ...
    <title>AD14 | Thêm tài khoản admin</title>
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="images/ai.jpg" alt="..." class="img-circle profile_img">
                    </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Biên Bản <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Quyết định <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="#">Xem danh sách</a></li>
                                    <li><a href="#">Tạo mới</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-edit"></i> Biểu đồ thống kê <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="#">Xem biểu đồ</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-edit"></i> Hình ảnh <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="#">Xem danh sách</a></li>
                                    <li><a href="#">Tạo mới</a></li>
                                </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="images/ai.jpg" alt="">Kenny
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        <label for="mat_khau" class="control-label col-md-3 col-sm-3 col-xs-12">Mật khẩu <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="mat_khau" class="form-control col-md-7 col-xs-12" type="password" name="mat_khau">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="xac_nhan_mat_khau" class="control-label col-md-3 col-sm-3 col-xs-12">Xác nhận mật khẩu <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="xac_nhan_mat_khau" class="form-control col-md-7 col-xs-12" type="password" name="xac_nhan_mat_khau">
                                        </div>
                                    </div>
                                    <div class="form-group">
